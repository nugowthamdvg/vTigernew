...
public class TestScript6 extends Base
{
	...
	public void createProductTest2() throws InterruptedException
	{
		...
		cpro.getProductName().sendKeys(lib.getSpecifiedDataFromExcelFile(lib.getDataFromPrpoertyFile("Sheet4"), 2, 0));
		...
		cpro.getProductWeb().sendKeys(lib.getSpecifiedDataFromExcelFile(lib.getDataFromPrpoertyFile("Sheet4"), 2, 2));
		Reporter.log("Product Website is Entered",true);
		
		cpro.pgl(lib.getSpecifiedDataFromExcelFile(lib.getDataFromPrpoertyFile("Sheet4"), 2, 3));
		Reporter.log("Product GL Account is Selected",true);
		
		cpro.getProductSN().sendKeys(lib.getSpecifiedDataFromExcelFile(lib.getDataFromPrpoertyFile("Sheet4"), 2, 4));
